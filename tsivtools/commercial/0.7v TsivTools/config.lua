...
Config.teleports = {
    { label = 'Central Park',   coords = vector3(195.0, -933.0, 30.7) },
    { label = 'Police',  coords = vector3(441.0, -982.0, 30.7) },
    { label = 'Hospital',coords = vector3(298.0, -584.0, 43.3) },
    { label = 'Airport',         coords = vector3(-1037.0, -2737.0, 20.2) },
    { label = 'Sandy',    coords = vector3(1853.0, 3689.0, 34.3) },
    { label = 'Paleto',      coords = vector3(-109.0, 6467.0, 31.6) },
}
