...
local function ensureSchema()
    ...
    MySQL.update.await(([[
        CREATE TABLE IF NOT EXISTS `%s` (
            ...
            `content` VARCHAR(160) NOT NULL, `created_at` INT UNSIGNED NOT NULL DEFAULT 0,
            `expires_at` INT UNSIGNED NOT NULL DEFAULT 0, `added_by` VARCHAR(80) NOT NULL DEFAULT '',
    ...
    MySQL.update.await(([[
        CREATE TABLE IF NOT EXISTS `%s` (
            ...
            `related_name` VARCHAR(64) NOT NULL DEFAULT '', `note` VARCHAR(160) NOT NULL DEFAULT '',
            `created_at` INT UNSIGNED NOT NULL DEFAULT 0, `added_by` VARCHAR(80) NOT NULL DEFAULT '',
            PRIMARY KEY (`id`), KEY `identifier` (`identifier`)
        ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
