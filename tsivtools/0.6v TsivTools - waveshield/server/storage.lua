...
local function ensureSchema()
    ...
    MySQL.update.await(([[
        CREATE TABLE IF NOT EXISTS `%s` (
            ...
            `addedby` VARCHAR(80) NOT NULL DEFAULT '',
            `createdat` INT UNSIGNED NOT NULL DEFAULT 0,
            `active` TINYINT(1) NOT NULL DEFAULT 1,
    ...
    MySQL.update.await(([[
        CREATE TABLE IF NOT EXISTS `%s` (
            ...
            `content` VARCHAR(160) NOT NULL, `createdat` INT UNSIGNED NOT NULL DEFAULT 0,
            `expiresat` INT UNSIGNED NOT NULL DEFAULT 0, `addedby` VARCHAR(80) NOT NULL DEFAULT '',
    ...
    MySQL.update.await(([[
        CREATE TABLE IF NOT EXISTS `%s` (
            ...
            `name` VARCHAR(64) NOT NULL DEFAULT '', `at` INT UNSIGNED NOT NULL DEFAULT 0,
    ...
    MySQL.update.await(([[
        CREATE TABLE IF NOT EXISTS `%s` (
            `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
            `identifier` VARCHAR(80) NOT NULL, `relatedidentifier` VARCHAR(80) NOT NULL,
            `relatedname` VARCHAR(64) NOT NULL DEFAULT '', `note` VARCHAR(160) NOT NULL DEFAULT '',
            `createdat` INT UNSIGNED NOT NULL DEFAULT 0, `addedby` VARCHAR(80) NOT NULL DEFAULT '',
            PRIMARY KEY (`id`), KEY `identifier` (`identifier`)
        ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
